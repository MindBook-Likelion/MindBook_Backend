...
import org.oa.mindbook.Repository.User.EmailValidationRepository;
...
public class EmailService {
    ...
    private MimeMessage createMessage(String to)throws Exception{
        ...
        message.setSubject("마음책방 이메일 인증입니다.");//제목

        String msgg="";
        msgg+= "<div style='margin:20px;'>";
        msgg+= "<h1> 마음책방 인증번호입니다. </h1>";
        msgg+= "<br>";
        ...
        message.setFrom(new InternetAddress("maeumchaegbang","마음책방"));//보내는 사람
    ...
    private MimeMessage createPasswordMessage(String to)throws Exception{
        ...
        insertPw(to, newPw);
        message.addRecipients(MimeMessage.RecipientType.TO, to);//보내는 대상
        message.setSubject("마음책방 임시 비밀번호입니다.");//제목

        String msgg="";
        msgg+= "<div style='margin:20px;'>";
        msgg+= "<h1> 마음책방 임시 인증비밀번호입니다. </h1>";
        msgg+= "<br>";
    ...
    public boolean ValidationCheck(String email, String code){
        EmailValidation emailValidation = emailRepository.findById(email).orElseThrow( () -> new RuntimeException("Invalid value: email not found"));
        Date now = new Date();
        //expiration Check
